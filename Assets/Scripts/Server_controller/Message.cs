...
namespace Assets.Server_controller
{
    public class Message
    {
        ...
        public static Message CreatePlayerCommandMessage(int playerNo = 1, bool moveUp = false, bool moveDown = false,
            bool moveLeft = false, bool moveRight = false, bool rotateLeft = false, bool rotateRight = false)
        {
            return new Message(102, CreatePlayerCommandText(playerNo, moveUp, moveDown,
                moveLeft, moveRight, rotateLeft, rotateRight));
        }

        public static string CreatePlayerCommandText(int playerNo = 1, bool moveUp = false, bool moveDown = false,
            bool moveLeft = false, bool moveRight = false, bool rotateLeft = false, bool rotateRight = false)
        {
            var toReturn = new Dictionary<string, string>();
            toReturn.Add("playerNo", playerNo.ToString());
            toReturn.Add("moveUp", moveUp ? "1" : "0");
            toReturn.Add("moveDown", moveDown ? "1" : "0");
            toReturn.Add("moveLeft", moveLeft ? "1" : "0");
            toReturn.Add("moveRight", moveRight ? "1" : "0");
